...
const Navbar = () => {
  ...
  return (
    <>
                ...
                <div className="navbar-start space-x-10 w-full">
                  <div className="flex items-center">
                    <img
                      ...
                      alt="Logo"
                    />
                    <a className="p-2 text-[18px] lg:text-[22px] font-bold text-[#e02f21]">
                      RoshoiBondhu
                    </a>
                  </div>
                ...
                <div className="navbar-end">
                  ...
                  {user ? (
                    <button onClick={logoutUser}>
                      <FiLogOut className="w-6 h-6 lg:mr-6 ml-3 lg:ml-0 hover:cursor-pointer hover:text-[#e02f21]" />
                    </button>
                  ) : (
                    ""
                  )}
                  ...
                  <Link
                    to="/add-recipe"
                    className="btn border-0 bg-[#dbdbdbc5] px-4 py-3 hover:bg-[#e02f21] hover:text-white hidden lg:block dark:bg-gray-700 dark:text-white"
                  >
                    Add recipe
                  </Link>
                </div>
      ...
      {!scrolled && (
        <div className="navbar px-3 pt-4 md:px-0 md:max-w-4/5 mx-auto">
          ...
          <div className="navbar-end">
            ...
            {user ? (
              <button onClick={logoutUser}>
                <FiLogOut className="w-6 h-6 mr-0 lg:mr-6  ml-3 lg:ml-0 hover:cursor-pointer hover:text-[#e02f21]" />
              </button>
            ) : (
              ""
            )}
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white z-50 p-4 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <ul className="space-y-6 font-bold mt-12">
          ...
          <Link
            to="/add-recipe"
            className="btn border-0 bg-[#dbdbdbc5] px-4 py-3 hover:bg-[#e02f21] hover:text-white"
          >
            Add recipe
          </Link>
        </ul>
